...
namespace neu
{
	bool CubemapTextue::Create(std::string filename, ...)
	{
	...
	bool CubemapTextue::Load(const std::vector<std::string>& filename)
	{
	...
	std::vector<std::string> CubemapTextue::GenerateCubeMapNames(const std::string& basename, const std::string& extension)
	{
